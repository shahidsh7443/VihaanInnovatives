...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'buildup-pro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'buildup-pro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'buildup-pro' ),
		'repeat'    => __( 'Repeat All', 'buildup-pro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'buildup-pro' ),
		'top center'    => __( 'Top Center', 'buildup-pro' ),
		'top right'     => __( 'Top Right', 'buildup-pro' ),
		'center left'   => __( 'Middle Left', 'buildup-pro' ),
		'center center' => __( 'Middle Center', 'buildup-pro' ),
		'center right'  => __( 'Middle Right', 'buildup-pro' ),
		'bottom left'   => __( 'Bottom Left', 'buildup-pro' ),
		'bottom center' => __( 'Bottom Center', 'buildup-pro' ),
		'bottom right'  => __( 'Bottom Right', 'buildup-pro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'buildup-pro' ),
		'fixed'  => __( 'Fixed in Place', 'buildup-pro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'buildup-pro' ),
		'italic'      => __( 'Italic', 'buildup-pro' ),
		'bold'        => __( 'Bold', 'buildup-pro' ),
		'bold italic' => __( 'Bold Italic', 'buildup-pro' )
		);
